...
To use the device-owner-only APIs (`rebootDevice`, `addToLockTaskMode`, `setAsPersistentHomeActivity`, `setLockTaskFeatures`), the app must first be provisioned as the device owner, e.g.:
